...
html_code = f'''
    <a href="{github_repo_url}" target="_blank"><img src="{github_icon_url}" alt="GitHub" style="width:25px;height:25px;margin-right:5px;"></a>
    <a href="{twitter_profile_url}" target="_blank"><img src="{twitter_icon_url}" alt="Twitter" style="width:21px;height:21px;margin-right:5px;"></a>
